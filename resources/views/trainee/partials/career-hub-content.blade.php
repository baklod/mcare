...
<header class="border-b border-slate-200 pb-6">
    ...
    <div class="mt-3 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
        <div>
            ...
            <p class="mt-2 text-sm text-slate-600">Privacy-reviewed caregiving opportunities for MCARE graduates.</p>
        </div>
...
<section aria-labelledby="career-board-title">
    <div class="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <div><p class="dashboard-section-kicker">Open duties</p><h2 id="career-board-title" class="mt-1 text-2xl font-black text-slate-950">Caregiving opportunities</h2></div>
