...
<head>
    ...
    <title>MCARE application update</title>
</head>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="max-width:560px;margin:0 auto;font-family:Arial,Helvetica,sans-serif;">
                    ...
                    <tr>
                        <td style="padding:4px 0 16px;">
                            <h1 style="margin:0;font-family:Arial,Helvetica,sans-serif;font-size:20px;font-weight:normal;line-height:1.4;color:#0f172a;">Application update</h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:16px 0;">
                    ...
                    <tr>
                        <td style="padding:4px 0 16px;font-family:Arial,Helvetica,sans-serif;font-size:15px;font-weight:normal;color:#334155;">
                            ...
                            <p style="margin:0;font-family:Arial,Helvetica,sans-serif;font-size:15px;font-weight:normal;">MCARE completed the review of this application and did not approve it. You may submit a new application after correcting the reason noted by MCARE administration.</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:16px 0;">
