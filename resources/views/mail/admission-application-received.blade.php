...
<head>
    ...
    <title>Your MCARE application number</title>
</head>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="max-width:560px;margin:0 auto;font-family:Arial,Helvetica,sans-serif;">
                    ...
                    <tr>
                        <td style="padding:4px 0 16px;">
                            <h1 style="margin:0;font-family:Arial,Helvetica,sans-serif;font-size:20px;font-weight:normal;line-height:1.4;color:#0f172a;">Your application was received</h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:16px 0;">
                    ...
                    <tr>
                        <td style="padding:4px 0 16px;font-family:Arial,Helvetica,sans-serif;font-size:15px;font-weight:normal;color:#334155;">
                            ...
                            <p style="margin:0;font-family:Arial,Helvetica,sans-serif;font-size:15px;font-weight:normal;">MCARE received your {{ $program }} application. Keep a copy of the application number below. You will use it to check your status and to open the enrollment form after approval.</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:16px 0;">
                    ...
                    <tr>
                        <td style="padding:4px 0 16px;font-family:Arial,Helvetica,sans-serif;font-size:15px;font-weight:normal;">
                            <a href="{{ $statusUrl }}" style="color:#5b21b6;font-family:Arial,Helvetica,sans-serif;font-weight:normal;text-decoration:underline;">Check application status</a>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:16px 0;">
                    ...
                    <tr>
                        <td style="padding:4px 0 16px;font-family:Arial,Helvetica,sans-serif;font-size:14px;font-weight:normal;color:#64748b;">
                            <p style="margin:0;font-family:Arial,Helvetica,sans-serif;font-size:14px;font-weight:normal;">An administrator will review this application. Enrollment opens only after it is approved.</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:16px 0;">
