...
@section('content')
    <section class="mx-auto grid max-w-5xl grid-cols-1 overflow-hidden rounded-3xl border border-purple-100 bg-white shadow-xl shadow-purple-100/40 lg:grid-cols-[1fr_420px]">
