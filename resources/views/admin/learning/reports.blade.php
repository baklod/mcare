...
<section class="space-y-6">
    <p class="max-w-3xl text-sm leading-6 text-slate-600">Compare enrollment, AM/PM distribution, approvals, verified payments, and trainer-published modules without mixing operational queues.</p>
    <div class="dashboard-table-wrap overflow-x-auto"><table class="dashboard-table w-full min-w-[64rem]"><thead><tr><th>Batch</th><th>Enrollment</th><th>Training</th><th>Applications</th><th>AM</th><th>PM</th><th>Approved</th><th>Paid</th><th>Modules</th></tr></thead><tbody>
