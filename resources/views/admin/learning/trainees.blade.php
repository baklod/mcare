...
<section class="space-y-6">
    <p class="max-w-3xl text-sm leading-6 text-slate-600">Monitor approved learners by batch and AM/PM class before attendance, assessment, and progress records are added.</p>
    ...
    <div class="dashboard-table-wrap overflow-x-auto"><table class="dashboard-table w-full min-w-[58rem]"><thead><tr><th>Trainee</th><th>Batch</th><th>Schedule</th><th>Payment</th><th>Training state</th><th>Record</th></tr></thead><tbody>
